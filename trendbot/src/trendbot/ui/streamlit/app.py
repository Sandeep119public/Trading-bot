...
# DataService selects the concrete provider from the requested source. The
# fallback provider is retained for compatibility with existing construction.
...
with st.sidebar:
    ...
    current_source = st.session_state.get("data_source", "delta_india")
